<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-4 px-lg-5 ">
                ...
                <img src="uploads/paw1.png" width="60" height="40" class="d-inline-block align-top" alt="" loading="lazy">
                PETS.COM
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent" >
                          ...
                          <a class="nav-link dropdown-toggle" id="navbarDropdown<?php echo $crow['id'] ?>" href="#" role="button" data-toggle="dropdown" aria-expanded="false"><?php echo $crow['category'] ?></a></a>
                            <ul class="dropdown-menu  p-0" aria-labelledby="navbarDropdown<?php echo $crow['id'] ?>">
                              <?php while($srow = $sub_qry->fetch_assoc()): ?>
                                <li><a class="dropdown-item border-bottom" href="./?p=products&c=<?php echo md5($crow['id']) ?>&s=<?php echo md5($srow['id']) ?>" style="background: #C6518C ; color: white;"><?php echo $srow['sub_category'] ?></a></li>
                            <?php endwhile; ?>
                            </ul>
                        </li>
                        <?php endif; ?>
                    ...
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        <button class="btn btn-secondary ml-2" id="login-btn" type="button">Login</button>
                        <?php else: ?>
                        <a class="text-dark mr-2 nav-link" href="./?p=cart" style="background: #ADA4A8;">
                            <i class="bi-cart-fill me-1"></i>
                            Cart
                            <span class="badge badge-warning text-white ms-1 rounded-pill" id="cart-count">
                              <?php 
                            ...
                            <a href="./?p=my_account" class="text-dark  nav-link"><b style="color: #ADA4A8;"> Hi, <?php echo $_settings->userdata('firstname')?>!</b></a>
                            <a href="logout.php" class="text-dark  nav-link"><i class="fa fa-sign-out-alt" style="color: #ADA4A8;"></i></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
