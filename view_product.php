...
?>
<section class="py-5" style="background: url(uploads/aaa.jpg);">
...
<section class="py-5 bg-light"style="background: url(uploads/aaa.jpg);" >
    <div class="container px-4 px-lg-5 mt-5" style="background: #EDDDE5    ">
        <h2 class="fw-bolder mb-4" style="font-family: Script MT Bold; text-align: center;">Related products</h2>
        ...
        ?>
            <div class="col mb-5">
                <div class="card h-100 product-item" style="background:#E0D9DD">
                    <!-- Product image-->
                    ...
                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                        <div class="text-center">
                            <a class="btn btn-flat btn-secondary "   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">View</a>
                        </div>
