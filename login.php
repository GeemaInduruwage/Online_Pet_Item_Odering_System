...
<div class="container-fluid" style="background:#D68AB2  ;">
    ...
    <h3 class="float-right">
        ...
        <div class="col-lg-12">
            <img src="uploads/paw1.png" width="80" height="50" ><h3 class="text-center" style="font-family: Script MT Bold;">Login</h3>
            <hr>
            <form action="" id="login-form">
                ...
                <div class="form-group d-flex justify-content-between">
                    <a href="javascript:void()" id="create_account" style="color: black; font-family: Script MT Bold;">Create Account</a>
                    <button class="btn btn-secondary btn-flat" style="font-family: Script MT Bold;">Login</button>
                </div>
            </form>
        </div>
    </div>
