...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=product/manage_product" class="btn btn-light"><span class="fas fa-plus"></span>  Create New</a>
			<a href="product/a.php" class="btn btn-light">view the XML about the client details</a>
		</div>
	</div>
	<div class="card-body">
